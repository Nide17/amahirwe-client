    ...
    return (
        <div>
            <div className="jumbotron m-md-5 py-1 text-center text-center">
                ...
                <p className="lead">
                    Amahirwe is a web application that helps people to buy, sell or rent anything. It gives people good time to search, plan and decide what to buy, sell or rent. It also gives information about jobs and scholarships and tenders.
                </p>
